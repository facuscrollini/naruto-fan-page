...
export const HomeButton = ({dropDown, setDropDown}:Props) => {
    ...
    return (
        <Link to="/">
            <button onClick={()=> dropDown && setDropDown(!dropDown)} className="bg-cyan-100 active:bg-cyan-200 m-3 px-3 pt-1 pb-2 hover:cursor-pointer rounded-b-4xl absolute -top-3 border-cyan-900 border-t-0 border-x-1 border-b-4 " type="button">
