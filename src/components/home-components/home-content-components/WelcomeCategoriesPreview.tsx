  ...
  return (
    <div className="h-[50vh] rounded-2xl overflow-hidden">
      <label className="relative group hover:cursor-pointer">
        ...
        <div className="absolute max-lg:peer-checked:opacity-100 md:opacity-0 group-hover:opacity-100 bg-linear-to-t from-black to-transparent transition-all lg:duration-1000  inset-0"></div>
        <div className="absolute left-1/16 right-1/16 max-lg:peer-checked:opacity-100 bottom-1/8 lg:bottom-0 group-hover:bottom-1/8 md:opacity-0  transition-all duration-1000 group-hover:opacity-90 text-white text-left">
